        ...
        value: function render() {
            ...
            if (cellUnit === _index.CellUnits.Hour) {
                ...
                headerList = headers.map(function (item, index) {
                    ...
                    var cellFormat = cellUnit === _index.CellUnits.Week ? config.nonAgendaWeekCellHeaderFormat : cellUnit === _index.CellUnits.Month ? config.nonAgendaMonthCellHeaderFormat : cellUnit === _index.CellUnits.Year ? config.nonAgendaYearCellHeaderFormat : config.nonAgendaOtherCellHeaderFormat;
