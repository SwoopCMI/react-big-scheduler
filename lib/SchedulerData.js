    ...
    _createClass(SchedulerData, [{
        ...
        value: function _createHeaders() {
            ...
            if (this.showAgenda) {
                ...
                } else if (this.cellUnit === _index.CellUnits.Day) {
                    while (header >= start && header <= end) {
        ...
        value: function _createInitHeaderEvents(header) {
            ...
            var endValue = this.showAgenda ? this.viewType === _index.ViewTypes.Week ? start.add(1, 'weeks').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Day ? start.add(1, 'days').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Month ? start.add(1, 'months').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Year ? start.add(1, 'years').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Quarter ? start.add(1, 'quarters').format(_index.DATETIME_FORMAT) : this.localeMoment(this.endDate).add(1, 'days').format(_index.DATETIME_FORMAT) : this.cellUnit === _index.CellUnits.Hour ? start.add(this.config.minuteStep, 'minutes').format(_index.DATETIME_FORMAT) : this.cellUnit === _index.CellUnits.Year ? start.add(1, 'years').format(_index.DATE_FORMAT) : this.cellUnit === _index.CellUnits.Month ? start.add(1, 'months').format(_index.DATE_FORMAT) : this.cellUnit === _index.CellUnits.Week ? start.add(1, 'weeks').format(_index.DATE_FORMAT) : start.add(1, 'days').format(_index.DATETIME_FORMAT);
            return {
                time: header.time,
            ...
            try {
                for (var _iterator = headers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    var spanStart = this.localeMoment(header.time),
                        spanEnd = this.cellUnit === _index.CellUnits.Hour ? this.localeMoment(header.time).add(this.config.minuteStep, 'minutes') : this.cellUnit === _index.CellUnits.Week ? this.localeMoment(header.time).add(1, 'weeks') : this.cellUnit === _index.CellUnits.Month ? this.localeMoment(header.time).add(1, 'months') : this.cellUnit === _index.CellUnits.Year ? this.localeMoment(header.time).add(1, 'year') : this.localeMoment(header.time).add(1, 'days');
